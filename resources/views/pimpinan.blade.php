    ...
    <div class="container-fluid p-0">
        ...
        <main>
                ...
                <aside>
                    <div class="profile-menu">
                        ...
                        <ul>
                            ...
                            <li class="active"><a href="{{ url('pimpinan') }}">Pimpinan Fakultas</a></li>
            ...
            <div class="col-lg-8">
                        ...
                        {!! nl2br(e($leader->description)) !!}
                            <div class="contact-profile mt-3">
                                <div class="contact-item">
                                    ...
                                    <span class="text">NIP. {{ $leader->nip }}</span>
                                </div>
                                <div class="contact-item">
                                    <span class="icon"><i class="fas fa-envelope"></i></span>
                                    <span class="text">{{ $leader->email }}</span>
                                </div>
                            </div>
                        </article>
                        </div>
                ...
                @empty
                    <p>Belum ada data pimpinan yang ditambahkan.</p>
                @endforelse
                </div>
            </div>
            </div>
